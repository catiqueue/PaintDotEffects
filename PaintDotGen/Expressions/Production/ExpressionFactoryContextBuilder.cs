...
internal static class ExpressionFactoryContextBuilderExtensions {
  public static ExpressionFactoryContextBuilder FromSettings(this ExpressionFactoryContextBuilder ctx,
    Settings settings, Size<int> canvasSize)
    => ctx
