...
internal static class ExpressionExtensions {
  ...
  public static byte EvaluateToNormalizedByte(this IGeneratorExpression expr, float x, float y) 
  ...
  => new(b: container.B.EvaluateToNormalizedByte(x, y), 
         g: container.G.EvaluateToNormalizedByte(x, y), 
         r: container.R.EvaluateToNormalizedByte(x, y), 
         a: 255);
