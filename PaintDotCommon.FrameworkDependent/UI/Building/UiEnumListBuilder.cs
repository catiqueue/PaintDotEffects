  ...
  where TValue : notnull 
{
  ...
  public UiEnumListBuilder<TSettings, TParent, TValue> WithChoice(TValue value) => WithChoice(value, value.ToString() ?? string.Empty);
  
  public override ChoiceListNode<TValue> Build() {
